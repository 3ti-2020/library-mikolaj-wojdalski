...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Maj 2020, 20:07
...
(9, 'Dziady', 9788361237563),
(10, 'Lokomotywa', 9788385247036);
...
--
ALTER TABLE `tytuły`
  MODIFY `id_tytul` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT dla tabeli `x`
--
ALTER TABLE `x`
  MODIFY `id_x` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
